                    ...
                    <div class="product__details__pic">
                        <div class="product__details__pic__item">
                            <img class="product__details__pic__item--large"
                                src="img/product/details/pic-1.jpg" alt="">
                        </div>
                        <div class="product__details__pic__slider owl-carousel">
                            <img data-imgbigurl="img/product/details/pic-1.jpg"
                                src="img/product/details/pic-1.jpg" alt="">
                            <img data-imgbigurl="img/product/details/pic-2.jpg"
                                src="img/product/details/pic-2.jpg" alt="">
                            <img data-imgbigurl="img/product/details/pic-3.jpg"
                                src="img/product/details/pic-3.jpg" alt="">
                            <img data-imgbigurl="img/product/details/pic4.jpg"
                                src="img/product/details/pic-4.jpg" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <ul>
                                <li><b>Số lượng</b> <span>30 sản phẩm có sẵn</span></li>
