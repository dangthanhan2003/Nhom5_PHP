                    ...
                    ?>
                            <form class="user" method="post" action="">
                                <div class="form-group">
                                    <input type="text" value="<?php echo $result['catName'] ?>" class="form-control form-control-user" name="catName" aria-describedby="emailHelp" placeholder="Nhập tên danh mục">
                                </div>
