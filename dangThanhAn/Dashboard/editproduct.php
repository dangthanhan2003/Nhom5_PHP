    ...
    echo "<img src='$img' height='100px' />";
                    ...
                    <div class="form-group row">
                        ...
                        <input type="text" class="form-control form-control-user"
                            ...
                            placeholder="Giá gốc"  value="<?=$product['purchase']?>">
                        </div>
                        <div class="col-sm-4 mb-sm-0">
                        <input type="text" class="form-control form-control-user"
                            id="giaban" name="giaban" aria-describedby="emailHelp"
                            placeholder="Giá bán:"  value="<?=$product['price']?>">
                        </div>
                    </div>
                    <div class="form-group">
        ...
        <?php } ?>
                    ...
                    <label class="form-label">Trạng thái:</label>
                                    <select class="form-control" id="pstatus" name="pstatus">
                                        <option value="active" <?php $product['pstatus'] = 'active'; ?>>Active</option>
                                        <option value="inactive" <?php $product['pstatus'] = 'inactive'; ?>>Inactive</option>
                                    </select>
                                </div>
